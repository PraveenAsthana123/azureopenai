# ==============================================================================
# Enterprise RAG Knowledge Copilot - Terraform Infrastructure
# ==============================================================================
...
# ==============================================================================
# Cosmos DB (Chat History & Sessions)
# ==============================================================================
...
resource "azurerm_linux_function_app" "rag_orchestrator" {
  name                       = "func-rag-${local.resource_prefix}"
  location                   = azurerm_resource_group.main.location
  resource_group_name        = azurerm_resource_group.main.name
...
resource "azurerm_private_endpoint" "openai" {
  name                = "pe-openai-${local.resource_prefix}"
  location            = azurerm_resource_group.main.location
  resource_group_name = azurerm_resource_group.main.name
...
resource "azurerm_private_endpoint" "search" {
  name                = "pe-search-${local.resource_prefix}"
  location            = azurerm_resource_group.main.location
  resource_group_name = azurerm_resource_group.main.name
  subnet_id           = azurerm_subnet.private_endpoints.id
...
resource "azurerm_private_endpoint" "storage" {
  name                = "pe-storage-${local.resource_prefix}"
  location            = azurerm_resource_group.main.location
  resource_group_name = azurerm_resource_group.main.name
  subnet_id           = azurerm_subnet.private_endpoints.id
...
resource "azurerm_private_endpoint" "keyvault" {
  name                = "pe-keyvault-${local.resource_prefix}"
  location            = azurerm_resource_group.main.location
  resource_group_name = azurerm_resource_group.main.name
  subnet_id           = azurerm_subnet.private_endpoints.id
...
resource "azurerm_role_assignment" "function_openai" {
  ...
  principal_id         = azurerm_linux_function_app.rag_orchestrator.identity[0].principal_id
}
...
output "function_app_url" {
  value = "https://${azurerm_linux_function_app.rag_orchestrator.default_hostname}"
}
